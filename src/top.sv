...
// For /fpga_pins/fpga|calc$out_digit.
logic [7:0] FpgaPins_Fpga_CALC_out_digit_a4;
...
logic FpgaPins_Fpga_CALC_reset_n1,
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $reset.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_reset_a0 <= FpgaPins_Fpga_CALC_reset_n1;
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [7:0] \///@4$out_digit ;
               assign \///@4$out_digit = FpgaPins_Fpga_CALC_out_digit_a4;
               ...
               (* keep *) logic  \///@-1$reset ;
               assign \///@-1$reset = FpgaPins_Fpga_CALC_reset_n1;
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 229 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 232 as: m5+board(/top, /fpga, 7, $, , calc)
               ...
               //_|calc
                  ...
                  //_@3
                     ...
                     assign FpgaPins_Fpga_CALC_out_a3[7:0] =
                        ...
                        !FpgaPins_Fpga_CALC_valid_a3
                           ? FpgaPins_Fpga_CALC_out_a4 :
                        FpgaPins_Fpga_CALC_op_a3[2:0] == 3'b111
                           ? FpgaPins_Fpga_CALC_reset_a3 :
                  ...
                  //_@4
                     ...
                     assign FpgaPins_Fpga_CALC_digit_a4[3:0] = FpgaPins_Fpga_CALC_out_a4[3:0];
                     assign FpgaPins_Fpga_CALC_out_digit_a4[7:0] =
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h0 //2'b0000
                           ? 8'b00111111 ://0
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h1 //2'b0001
                           ? 8'b00000110 ://1
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h2
                           ? 8'b01011011 ://2
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h3
                           ? 8'b01001111 ://3
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h4
                           ? 8'b01100110 ://4
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h5
                           ? 8'b01101101 ://5
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h6
                           ? 8'b01111101 ://6
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h7
                           ? 8'b00000111 ://7
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h8
                           ? 8'b01111111 ://8
                        FpgaPins_Fpga_CALC_digit_a4 == 4'h9
                           ? 8'b01101111 ://9
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 234 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
